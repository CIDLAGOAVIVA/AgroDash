...
export function FieldMap({ crops, activeCrop, onMarkerClick }: FieldMapProps) {
    ...
    return (
        <Card className="h-full">
            <CardHeader>
                <CardTitle>Mapa dos Talhões (IA em Tempo Real)</CardTitle>
                <CardDescription>Imagem de satélite gerada por IA da cultura selecionada.</CardDescription>
            </CardHeader>
            <CardContent>
                <div className="relative w-full h-96 bg-muted/50 rounded-lg overflow-hidden border">
                    {activeCrop?.imageUrl ? (
                        <img 
                          ...
                          key={activeCrop.imageUrl} // Força o rerender da imagem
                        />
                    ) : (
                        ...
                        return (
                            ...
                            >
                                <div className={cn(
                                    ...
                                    color,
                                    isActive ? 'ring-4 ring-offset-2 ring-primary' : 'ring-0'
                                )}></div>
                                 <div className={cn(
